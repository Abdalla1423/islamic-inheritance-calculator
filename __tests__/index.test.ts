...
describe("ALL TESTS", () => {
  ...
  //40
  test('wife, 1 daughter, mother, 1 full_uncle', () => {
    const result = calculate({
      wife: 1,
      daughter: 1,
      mother: 1,
  ...
  //60 --> falsch
  test('wife, 1 daughter, father, mother, 1 full_brother', () => {
    const result = calculate({
      wife: 1,
      daughter: 1,
      father: 1,
    ...
    checkResult(result, 'wife', f(1,8))
    checkResult(result, 'daughter', f(1,2))
    checkResult(result, 'father', f(5,24))
    checkResult(result, 'mother', f(1,6))
  })

  //121
  test('wife, 2 daughter, mother', () => {
    const result = calculate({
      wife: 1,
      daughter: 2,
      mother: 1,
    ...
    checkResult(result, 'wife', f(1,8))
    checkResult(result, 'daughter', f(7,10))
